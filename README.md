...
#### Wallet
```go
import "github.com/guotie/neoutils"
```
...
#### NEO JSON RPC
```go
import "github.com/guotie/neoutils/neorpc"
```
...
#### City of Zion APIs
```go
import "github.com/guotie/neoutils/coz"
```
...
#### NEO Smart contract
```go
import "github.com/guotie/neoutils/smartcontract"
```
